...
#' @param do_warn logical: if `FALSE`, suppress warnings issued directly by this function (but warnings generated by downstream code will still occur)
#'
#' @return A character vector of codes. This will be the same as the input `code` vector, but potentially with additional green code entries (`*$$&H#`, `*$$&H=`, `a$$&H#`, `a$$&H=`) inserted before the last entry
#'
#' @export
