# The phase of play associated with each action
#
...
# @return character vector, where the entries are "Serve", "Reception" (serve reception and the set and attack immediately following it, as well as the opposition block on that attack),
